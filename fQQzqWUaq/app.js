...
App({
  ...
  dataInitial: function () {
    ...
    if (hotelListArr.length > 0) {
      let compid = hotelListArr[i].name;
      that.getLocation({
        success: function (res) {
          var lat = res.latitude;
          var lng = res.longitude;
  ...
  submitForm: function (dataset, formId) {
    let pageInstance = this.getNowPage();
    let that = this;
    let compid = dataset.compid;
  ...
  submitComment: function (dataset) {
        ...
        if (res.code == 1) {
          ...
          for (var i in res.datalist) {
            for (var j in res.datalist[i].formdata) {
              ...
              if (typeof description == 'string' && !/^(http:||https:)\/\//g.test(description)) {
  ...
  bindCityChange: function (id, val) {
    let pageInstance = this.getNowPage();
  ...
  submitCity: function (id, bindlist) {
    let pageInstance = this.getNowPage();
    let newdata = pageInstance.data;
  ...
  showCart: function (compid, childid) {
    var pageInstance = this.getNowPage();
    var comdata = pageInstance['data'][compid];
    pageInstance.setData({
  ...
  changeComment: function (status, compid, childid) {
    var pageInstance = this.getNowPage();
    var comdata = pageInstance['data'][compid];
  ...
  loadMoreEval: function (compid, childid) {
    var pageInstance = this.getNowPage();
    var comdata = pageInstance['data'][compid];
  ...
  clearCart: function (compid, childid) {
    var pageInstance = this.getNowPage();
    var comdata = pageInstance['data'][compid];
    that.showModal({
      content: '清空购物车？',
  ...
  changeCart: function (dataset, childid) {
    var compid = dataset.compid;
    var pageInstance = this.getNowPage();
    var comdata = pageInstance['data'][compid];
    ...
    wx.request({
      ...
      success: function ({ data }) {
        if (data.code == 1) {
          /*for (let i = 0; i < newallGoods.length; i++) {
            for (let j = 0; j < newallGoods[i].length; j++) {
              if (newallGoods[i][j].id == goods.good_id) {
                if (type == 'add') {
                  newallGoods[i][j].carnums++
                } else {
                  newallGoods[i][j].carnums--
                }
                break;
          ...
          for (let i = 0; i < newgoodstype.length; i++) {
            if (newgoodstype[i].nid == goods.nid) {
              if (type == 'add') {
                newgoodstype[i].carnidnums++
              } else {
                newgoodstype[i].carnidnums--
              }
            }
  ...
  changeFoot: function (dataset, childid) {
    var compid = dataset.compid;
    var pageInstance = this.getNowPage();
    var comdata = pageInstance['data'][compid];
    let goods = dataset.goods;
    ...
    wx.request({
      ...
      success: function ({ data }) {
        if (data.code == 1) {
          /*if (type == 'add') {
            newallGoods[comdata.chooseNav][index].carnums++;
            newgoodstype[comdata.chooseNav].carnidnums++;
          } else {
            newallGoods[comdata.chooseNav][index].carnums--;
            newgoodstype[comdata.chooseNav].carnidnums--;
          }*/
  ...
  trueMulti: function (compid, childid) {
    var pageInstance = this.getNowPage();
    var comdata = pageInstance['data'][compid];
    ...
    wx.request({
      ...
      success: function ({ data }) {
        if (data.code == 1) {
          // newallGoods[comdata.chooseNav][comdata.multiIndex].carnums++;
          // newgoodstype[comdata.chooseNav].carnidnums++;
          newallGoods = data.goodsArr;
          newgoodstype = data.goodstype;
          pageInstance.setData({
  ...
  showMulti: function (dataset) {
    ...
    pageInstance.setData({
      ...
      // [`${compid}.multiprice`]: inventoryprice[0].price,
      [`${compid}.multiprice`]: 0,
      [`${compid}.multigoods`]: multigoods,
      [`${compid}.multiIndex`]: index,
      // [`${compid}.specstr`]: inventoryprice[0].spec_desc
      [`${compid}.specstr`]: ''
    })
  },
  chooseMulti: function (dataset) {
    var compid = dataset.compid;
    var pageInstance = this.getNowPage();
    var comdata = pageInstance['data'][compid];
    ...
    // let one = dataset.index;
    // let two = dataset.inx;
    // let nameone = dataset.nameone;
    // let nametwo = dataset.nametwo;
    // let newgoodspec = comdata.goodspec;
    // let specstr = '';
    // for (let i = 0; i < newgoodspec.length; i++) {
    //   if (i == one) {
    //     for (let j = 0; j < newgoodspec[i]['two'].length; j++) {
    //       if (j == two) {
    //         newgoodspec[i]['two'][j].check = 0
    //       } else {
    //         newgoodspec[i]['two'][j].check = 1
    //       }
    //     }
    //   }
    //   for (let j = 0; j < newgoodspec[i]['two'].length; j++) {
    //     if (newgoodspec[i]['two'][j].check == 0) {
    //       let nameone = newgoodspec[i].nameone;
    //       let nametwo = newgoodspec[i]['two'][j].nametwo;
    ...
    // }
    // pageInstance.setData({
    //   [`${compid}.goodspec`]: newgoodspec
    // })
    // for (let i = 0; i < comdata.inventoryprice.length; i++) {
    //   if (comdata.inventoryprice[i].spec_desc.includes(specstr)) {
    //     pageInstance.setData({
    //       [`${compid}.multiprice`]: comdata.inventoryprice[i].price,
  ...
  goToSeckDetail: function (dataset) {
    var pageInstance = this.getNowPage();
    var compid = dataset.compid;
    var comdata = pageInstance['data'][compid];
    var id = dataset.id;
  ...
  //搜索拼团商品
  searchGroupgoods: function (compid) {
    var pageInstance = this.getNowPage();
  ...
  //个人中心点击
  UserCenterPage: function (name, typeIndex) {
    var url = '';
    if (name == '全部订单' || name == '我的订单') {
      ...
      url = '/jifen/integralMall/integralMall';
    } else if (name == '我的拼团') {
  ...
  tagLbAppSearch: function (dataset) {
  ...
  clickLbAppSearch: function (dataset) {
    var pageInstance = this.getNowPage();
    var compid = dataset.compid;
    var nid = dataset.nid;
  ...
  changeAppCount: function (dataset) {
    var pageInstance = this.getNowPage();
  ...
  sortAppListFunc: function (dataset) {
    var compid = dataset.compid;
    var nid = dataset.nid;
    this.sortListFunc(dataset);
    this.dynamicListData(compid, nid);
  },
  searchGoods: function (dataset) {
    var pageInstance = this.getNowPage();
    var compid = dataset.compid;
  ...
  bindCommodity: function (eventParams) {
  ...
  bindGoodList: function (eventParams) {
    eventParams = JSON.parse(eventParams);
    var id = eventParams.bindid;
  ...
  bindArticle: function (eventParams) {
    eventParams = JSON.parse(eventParams);
    var id = eventParams.bindid;
    var allPages = this.globalData.Allpages;
  ...
  bindCoupon: function (eventParams) {
  ...
  bindAppointment: function (eventParams) {
    eventParams = JSON.parse(eventParams);
    var id = eventParams.bindid;
    var allPages = this.globalData.Allpages;
    var path = '/dianshang/goodsDetail/goodsDetail';
  ...
  bindTostore: function (eventParams) {
    eventParams = JSON.parse(eventParams);
    var id = eventParams.bindid;
    var allPages = this.globalData.Allpages;
    var path = '/dianshang/goodsDetail/goodsDetail';
  ...
  bindSonshop: function (eventParams) {
    eventParams = JSON.parse(eventParams);
    var id = eventParams.bindid;
    var allPages = this.globalData.Allpages;
  ...
  goToGoodsList: function (dataset) {
    var id = dataset.nid;
  ...
  goToListDetail: function (dataset) {
    var pageInstance = this.getNowPage();
    var compid = dataset.compid;
    var lid = dataset.lid;
  ...
  bindCommunity: function (eventParams) {
    eventParams = JSON.parse(eventParams);
    var id = eventParams.bindid;
    var allPages = this.globalData.Allpages;
  ...
  bindtakCoupon: function (eventParams) {
  ...
  sel_goods_type: function (dataset) {
    var pageInstance = this.getNowPage();
    var compid = dataset.compid;
    var compdata = pageInstance.data[compid];
  ...
  newloadmoreOrder: function (compid) {
    var pageInstance = this.getNowPage();
    var comdata = pageInstance['data'][compid];
    var prenum = comdata.prenum;
    var pagenum = comdata.pagenum;
  ...
  goToDistDetail: function (dataset) {
    var id = dataset.id;
  ...
  sel_dist_type: function (dataset) {
    var pageInstance = this.getNowPage();
    var compid = dataset.compid;
    var compdata = pageInstance.data[compid];
    var sel = dataset.sel;
  ...
  sel_groupgoods_type: function (dataset) {
    var pageInstance = this.getNowPage();
    var compid = dataset.compid;
    var compdata = pageInstance.data[compid];
    var type = compdata.listid;
  ...
  takeoutShowPre: function (dataset) {
    var compid = dataset.compid;
    var pageInstance = this.getNowPage();
    var compdata = pageInstance.data[compid];
  ...
  bindDisgood: function (eventParams) {
    eventParams = JSON.parse(eventParams);
    var id = eventParams.bindid;
    var allPages = this.globalData.Allpages;
  ...
  //同城
  changechecked: function (dataset) {
    var compid = dataset.compid;
    var pageInstance = this.getNowPage();
    var orderType = dataset.checked;
    var compdate = pageInstance.data[compid];
    if (orderType == 1) {
      if (compdate.lat == '' || compdate.lng == '') {
        this.reAutAddress(compid);
        return;
      }
    }
    var nid = dataset.nid;
  ...
  infoDetail: function (dataset) {
    ...
    var url = "/tongcheng/cityInfoDetail/cityInfoDetail?cid=" + dataset.cid + '&lat=' + lat + '&lng=' + lng;
    this.turnToPage(url);
  },
  release: function (dataset) {
    var compid = dataset.compid;
    var pageInstance = this.getNowPage();
    var url = "/pages/city_release/city_release";
    this.turnToPage(url);
  },
  previewImage: function (dataset) {
    var pageInstance = this.getNowPage();
    wx.previewImage({
      current: dataset.img,
      urls: dataset.urls,
  ...
  reAutAddress: function (compid) {
    var pageInstance = this.getNowPage();
    this.showModal({
      content: '未授权地理位置，是否授权？',
      showCancel: true,
      cancelText: '否',
      confirmText: '是',
      confirm: function () {
  ...
  changeClassify: function (compid, index, nid) {
    var pageInstance = this.getNowPage();
    var comdata = pageInstance['data'][compid];
    pageInstance.setData({
  ...
  newsel_goods_type: function (dataset) {
    var pageInstance = this.getNowPage();
    var compid = dataset.compid;
    var sel = dataset.sel;
    var compdata = pageInstance['data'][compid];
  ...
  goToGoodsDetail: function (dataset) {
    var id = dataset.id;
    var bindObj = dataset.bindobj;
    var url = '';
    if (bindObj == 0) {
  ...
  enterSearhText: function (compid, value) {
    var pageInstance = this.getNowPage();
    pageInstance.setData({
      [`${compid}.searchtxt`]: value
    });
  },
  clickSearch: function (compid) {
    var pageInstance = this.getNowPage();
    var comdata = pageInstance['data'][compid];
    pageInstance.setData({
      [`${compid}.goodlist`]: [],
  ...
  loadmoreTakOrder: function (compid) {
    var pageInstance = this.getNowPage();
    var comdata = pageInstance['data'][compid];
  ...
  showTakType: function (compid, type) {
    var pageInstance = this.getNowPage();
    var comdata = pageInstance['data'][compid];
  ...
  changeTakOrder: function (compid, status) {
    var pageInstance = this.getNowPage();
    var comdata = pageInstance['data'][compid];
    pageInstance.setData({
  ...
  goToTakDetail: function (dataset) {
    var pageInstance = this.getNowPage();
    var compid = dataset.compid;
  ...
  goToTakRefund: function (dataset) {
    var pageInstance = this.getNowPage();
    var orderid = dataset.orderid;
  ...
  goToTakVerify: function (dataset) {
    var pageInstance = this.getNowPage();
  ...
  scrollMoreSer: function (dataset) {
    var pageInstance = this.getNowPage();
    var nid = dataset.nid;
    var compid = dataset.compid;
    var compdata = pageInstance.data[compid];
  ...
  bindBespcoupon: function (eventParams) {
  ...
  searchApponitShop: function (compid) {
    var pageInstance = this.getNowPage();
  ...
  goToAppoint: function (compid, index) {
    var pageInstance = this.getNowPage();
    var compdata = pageInstance.data[compid];
  ...
  loadmoreAppoint: function (compid) {
    var pageInstance = this.getNowPage();
    if (!pageInstance.data[compid].loaded) {
      return;
    }
  ...
  openAppointMap: function (compid) {
    var pageInstance = this.getNowPage();
    wx.chooseLocation({
      success: function (res) {
        pageInstance.setData({
  ...
  NewUserCenterPage: function (dataset) {
    var pageInstance = this.getNowPage();
    ...
    if (name == '我的订单') {
      ...
      url = '/jifen/integralMall/integralMall?themecolor=' + themecolor;
    } else if (name == '我的拼团') {
      url = '/pintuan/myGrouporder/myGrouporder';
    } else if (name == '优惠券') {
    ...
    } else if (name == '微商城' || name == '微餐饮' || name == '微同城' || name == '微预约' || name == '我的砍价' || name == '分销中心' || name == '拼团中心' || name == '秒杀中心') {
  ...
  bindAllCoupon: function (eventParams) {
  ...
  bindSeckGoods: function (eventParams) {
    eventParams = JSON.parse(eventParams);
    var id = eventParams.bindid;
    var allPages = this.globalData.Allpages;
  ...
  bindGroupgoods: function (eventParams) {
    eventParams = JSON.parse(eventParams);
    var id = eventParams.bindid;
    var allPages = this.globalData.Allpages;
  ...
  bindBargaingoods: function (eventParams) {
    eventParams = JSON.parse(eventParams);
    var id = eventParams.bindid;
    var allPages = this.globalData.Allpages;
  ...
  loadmoreBargain: function (dataset) {
    var pageInstance = this.getNowPage();
    var compid = dataset.compid;
    var nid = dataset.nid;
    if (!pageInstance.data[compid].loaded) {
  ...
  goToBargainDetail: function (dataset) {
    var pageInstance = this.getNowPage();
    var compid = dataset.compid;
    var comdata = pageInstance['data'][compid];
    var id = dataset.id;
  ...
  scrollMoreGood: function (dataset) {
    var pageInstance = this.getNowPage();
    var nid = dataset.nid;
    var compid = dataset.compid;
    var compdata = pageInstance.data[compid];
  ...
  loadmoreGoods: function (dataset) {
    var pageInstance = this.getNowPage();
    var compid = dataset.compid;
    var nid = dataset.nid;
    var compdata = pageInstance.data[compid];
  ...
  scrollMoreGroupGood: function (dataset) {
    var pageInstance = this.getNowPage();
    var nid = dataset.nid;
    var compid = dataset.compid;
    var compdata = pageInstance.data[compid];
  ...
  loadmoreGroupGoods: function (dataset) {
    var pageInstance = this.getNowPage();
    var compid = dataset.compid;
    var nid = dataset.nid;
    var compdata = pageInstance.data[compid];
  ...
  scrollMoreSeckGood: function (dataset) {
    var pageInstance = this.getNowPage();
    var compid = dataset.compid;
    var compdata = pageInstance.data[compid];
    var prenum = compdata.prenum;
  ...
  loadmoreSeckGoods: function (dataset) {
    var pageInstance = this.getNowPage();
    var compid = dataset.compid;
    var compdata = pageInstance.data[compid];
    if (!compdata.loaddata) {
  ...
  scrollMoreDisGood: function (dataset) {
    var pageInstance = this.getNowPage();
    var compid = dataset.compid;
    var compdata = pageInstance.data[compid];
    var prenum = compdata.prenum;
  ...
  loadmoreDisGood: function (dataset) {
    var pageInstance = this.getNowPage();
    var compid = dataset.compid;
    var compdata = pageInstance.data[compid];
    if (!compdata.loaddata) {
  ...
  loadmoreTakShop: function (dataset) {
    var pageInstance = this.getNowPage();
    var compid = dataset.compid;
    var compdata = pageInstance.data[compid];
    var shownum = compdata.shownum;
  ...
  scrollMoreProduct: function (dataset) {
    var pageInstance = this.getNowPage();
    var compid = dataset.compid;
    var compdata = pageInstance.data[compid];
  ...
  loadmoreProduct: function (dataset) {
    var pageInstance = this.getNowPage();
    var compid = dataset.compid;
    var compdata = pageInstance.data[compid];
    var nid = compdata.listid;
  ...
  sel_subgoods_type: function (dataset) {
    var pageInstance = this.getNowPage();
    var compid = dataset.compid;
    var compdata = pageInstance.data[compid];
    var sel = dataset.sel;
  ...
  loadmoreSubGoods: function (dataset) {
    var pageInstance = this.getNowPage();
    var compid = dataset.compid;
    var compdata = pageInstance.data[compid];
    if (!compdata.loaddata) {
  ...
  searchSubGoods: function (dataset) {
    var pageInstance = this.getNowPage();
    var compid = dataset.compid;
    var goodslist = pageInstance.data[compid];
    goodslist.content = [];
  ...
  bindServer: function (eventParams) {
    eventParams = JSON.parse(eventParams);
    var id = eventParams.bindid;
    var allPages = this.globalData.Allpages;
  ...
  loadmoreCityShop: function (dataset) {
    var pageInstance = this.getNowPage();
    var compid = dataset.compid;
    var compdata = pageInstance.data[compid];
    if (!compdata.loaddata) {
  ...
  searchCityShop: function (compid) {
    var pageInstance = this.getNowPage();
  ...
  bindSubshop: function (eventParams) {
    eventParams = JSON.parse(eventParams);
    var id = eventParams.bindid;
  ...
  choTakshopClass: function (dataset) {
    var pageInstance = this.getNowPage();
    var compid = dataset.compid;
    var index = dataset.index;
    var nid = dataset.nid;
  ...
  choAppointshopClass: function (dataset) {
    var pageInstance = this.getNowPage();
    var compid = dataset.compid;
    var index = dataset.index;
    var nid = dataset.nid;
        ...
        success: function (res) {
          ...
          that.sendRequest({
            ...
            success: function (rres) {
              ...
              url = '/tongcheng/searchThecity/searchThecity?inputstype=' + inputstype;
              that.turnToPage(url);
            }
          })
        }
  ...
  loadmoreNewDisGood: function (dataset) {
    var pageInstance = this.getNowPage();
    var compid = dataset.compid;
    var compdata = pageInstance.data[compid];
    if (!compdata.loaddata) {
  ...
  sel_newdist_type: function (dataset) {
    var pageInstance = this.getNowPage();
    var compid = dataset.compid;
    var compdata = pageInstance.data[compid];
    var sel = dataset.sel;
  ...
  bindNewDisgood: function (eventParams) {
    eventParams = JSON.parse(eventParams);
    var id = eventParams.bindid;
    var allPages = this.globalData.Allpages;
    var path = '/dianshang/distDetail/distDetail';
  ...
  goToCancelOrder: function (dataset) {
    var pageInstance = this.getNowPage();
    var orderid = dataset.orderid;
    var index = dataset.idx;
    var compid = dataset.compid;
  ...
  loadMoreCoupon: function (compid) {
    var pageInstance = this.getNowPage();
    var comdata = pageInstance['data'][compid];
  ...
  searchGoodsShop: function (compid) {
    var pageInstance = this.getNowPage();
  ...
  goToShopHome: function (compid, index) {
    var pageInstance = this.getNowPage();
    var compdata = pageInstance.data[compid];
    var child_id = compdata.content[index].child_id;
  ...
  loadmoreGshops: function (compid) {
    var pageInstance = this.getNowPage();
    if (!pageInstance.data[compid].loaded) {
      return;
    }
  ...
  choGoodsshopClass: function (dataset) {
    var pageInstance = this.getNowPage();
    var compid = dataset.compid;
    var index = dataset.index;
    var nid = dataset.nid;
  ...
  textCopy: function (dataset) {
    var text = dataset.text;
    wx.setClipboardData({
      data: text,
    })
  },
  searchThecity: function (compid) {
    var pageInstance = this.getNowPage();
    ...
    var url = '/tongcheng/searchThecity/searchThecity';
    this.turnToPage(url);
  },
  searchCitylocation: function (compid) {
    var pageInstance = this.getNowPage();
    var cityData = pageInstance.data[compid];
    wx.setStorage({
      key: 'newcityData',
  ...
  sel_hotel_type: function (dataset){
    var pageInstance = this.getNowPage();
    var compid = dataset.compid;
  ...
  enterHotelName: function (compid, val){
    var pageInstance = this.getNowPage();
    pageInstance.setData({
      [`${compid}.storename`]: val
    })
  },
  searchHotel:function(compid){
    var pageInstance = this.getNowPage();
    pageInstance.setData({
      [`${compid}.pagenum`]: 1,
      [`${compid}.haveNums`]: 1,
  ...
  sel_showCla:function(compid){
    var pageInstance = this.getNowPage();
    pageInstance.setData({
      [`${compid}.showCla`]: !pageInstance.data[compid].showCla
    })
  },
  hotelTap: function (dataset) {
    var pageInstance = this.getNowPage();
    var compid = dataset.compid;
    var nid = dataset.nid;
    pageInstance.setData({
  ...
  sure_hotel_nid: function (dataset) {
    var pageInstance = this.getNowPage();
    var compid = dataset.compid;
    var type = dataset.type;
    var compdata = pageInstance.data[compid];
  ...
  chooseHouseNav: function (dataset) {
    var pageInstance = this.getNowPage();
    var compid = dataset.compid;
    var index = dataset.index;
    var compdata = pageInstance.data[compid];
  ...
  bindHoutelPicker: function (dataset, value) {
    var pageInstance = this.getNowPage();
    var compid = dataset.compid;
    var type = dataset.type;
  ...
  goToRoomDetail: function (dataset) {
    var pageInstance = this.getNowPage();
    var compid = dataset.compid;
  ...
  gotoHotelSearch:function(dataset){
    var compid = dataset.compid;
    var pageInstance = this.getNowPage();
    var comdata = pageInstance['data'][compid];
    var enter_time = comdata.enter_time;
